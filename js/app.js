...
if (state == "instructions") {
    ...
    ctx.fillText("Instructions will go here", canvas.width/2, canvas.height/2);
            ...
            drawPiece() {
                ...
                if (this.direction === "vert") {
                    if (this.length == 2) {
                        ...
                        ctx.drawImage(jagV, this.x, this.y, 100, 200);
                    ...
                    if (this.length == 2) {
                        ...
                        ctx.drawImage(jagH, this.x, this.y, 200, 100);
                    } else if (this.length !== 2) {
                        var lorryH = document.getElementById("lorryH");
                        ctx.drawImage(lorryH, this.x, this.y, 300, 100);
                    }
